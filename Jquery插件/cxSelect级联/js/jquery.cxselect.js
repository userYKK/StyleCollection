  ...
  $.cxSelect = function() {
    ...
    cxSelect.init = function() {
      ...
      for (var i = 0, l = arguments.length; i < l; i++) {
        console.info('第'+ i+ '个 arguments');
        console.info(arguments[i]);
        console.info(_isJquery(arguments[i]));
        console.info(_isElement(arguments[i]));
        console.info(typeof arguments[i]);
      ...
      console.info("---------- 设置settings ---------------")
      console.info(self.settings);
      // $.extend({}, $.cxSelect.defaults, _settings,..)} 将括号的内容进行合并，返回给 self.settings
      ...
      console.info('查看settings等----------------');
      console.info(self.dom.box)
      console.info(_dataSelects)

      if (typeof _dataSelects === 'string' && _dataSelects.length) {
        self.settings.selects = _dataSelects.split(',');
      };

      console.info(self.settings.selects)
      ...
      console.info('获取 self.selectArray')
      console.info(self.selectArray);
